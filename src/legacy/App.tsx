...
<body class="py-8 px-4 md:px-8 max-w-4xl mx-auto">
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans" dir="rtl">
      ...
      <header className="bg-[#080C16] border-b border-slate-800/80 py-3.5 px-6 flex flex-col md:flex-row justify-between items-center gap-4 shrink-0 shadow-lg">
        
        {/* BRAND & ORG */}
        <div className="flex items-center gap-4">
          <div className="p-2 bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-500/40 rounded-xl flex items-center justify-center text-cyan-400 shadow-[0_0_15px_-3px_rgba(6,182,212,0.3)]">
            <ShieldAlert className="w-6 h-6" />
          </div>
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-lg font-black tracking-tight text-white">Sniper AI</h1>
              <span className="text-[10px] bg-cyan-950 text-cyan-400 border border-cyan-500/30 px-2 py-0.5 rounded-full font-mono uppercase font-bold">Command Center</span>
            </div>
            <span className="text-xs text-slate-400 font-mono">Org: Acme Enterprise Corp</span>
          </div>
        </div>
        ...
        <div className="w-full md:w-96 relative">
          <div className="relative flex items-center">
            ...
            <input
              type="text"
              placeholder="Search: 'Find all critical API vulnerabilities'..."
              className="w-full bg-slate-950/80 border border-slate-800 rounded-xl pr-9 pl-4 py-2 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-cyan-500/60 font-mono transition-all"
            />
          </div>
        </div>

        {/* AI & USER PROFILE CONTROLS */}
        <div className="flex items-center gap-3">
          <button 
            onClick={() => setActiveTab('chat')}
            className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-amber-950/40 border border-amber-500/30 text-amber-300 text-xs font-bold hover:bg-amber-950/80 transition-all"
          >
          ...
          {userProfile ? (
            <button
              ...
              className="px-3 py-1.5 rounded-xl bg-slate-900 border border-slate-800 hover:bg-rose-950/50 hover:border-rose-800 text-slate-400 hover:text-rose-300 text-xs font-bold transition-all"
            >
              خروج
            </button>
          ) : (
      ...
      <div className="flex-1 flex flex-col md:flex-row min-h-0">
        ...
        {/* RIGHT SIDEBAR NAVIGATION MENU WITH CATEGORIES */}
        <aside className="w-full md:w-64 bg-[#080C16] border-b md:border-b-0 md:border-l border-slate-800/80 flex flex-col shrink-0 overflow-y-auto">
          <nav className="p-3 flex flex-row md:flex-col gap-1 overflow-x-auto md:overflow-x-visible shrink-0 text-right" dir="rtl">
            
            {/* CATEGORY 1: COMMAND CENTER */}
            <div className="px-3 py-2 text-[10px] font-mono font-bold text-cyan-400 uppercase tracking-wider">
              COMMAND CENTER
            </div>
            ...
            >
              ...
              <span>Overview (غرفة العمليات)</span>
            </button>
            ...
            >
              ...
              <span>Attack Surface (السطح الهجومي)</span>
            </button>
            ...
            >
              ...
              <span>Assets (الأصول المسجلة)</span>
            </button>
            ...
            >
              ...
              <span>Applications & Digital Twin</span>
            </button>

            {/* CATEGORY 2: SECURITY OPERATIONS */}
            <div className="px-3 py-2 mt-3 text-[10px] font-mono font-bold text-amber-400 uppercase tracking-wider">
              SECURITY OPERATIONS
            </div>

            <button
              onClick={() => setActiveTab('ai-pentest')}
              className={`flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs font-medium transition-all ${
            ...
            >
              ...
              <span>AI Pentest Mission (اختبار النفاذ)</span>
            </button>
            ...
            >
              ...
              <span>Vulnerabilities (سجل الثغرات)</span>
            ...
            >
              ...
              <span>Threat Intelligence (استخبارات)</span>
            </button>
            ...
            >
              ...
              <span>Scans Wizard (معالج الفحص)</span>
            </button>
            ...
            <div className="px-3 py-2 mt-3 text-[10px] font-mono font-bold text-emerald-400 uppercase tracking-wider">
              RISK MANAGEMENT
            </div>
            ...
            >
              ...
              <span>Risk Analytics (التحليلات)</span>
            </button>
            ...
            >
              ...
              <span>Compliance Center (الامتثال)</span>
            </button>
            ...
            <div className="px-3 py-2 mt-3 text-[10px] font-mono font-bold text-slate-400 uppercase tracking-wider">
              ADMINISTRATION
            </div>
            ...
            >
              <Activity className="w-4 h-4 text-cyan-400" />
              <span>Audit Logs (سجلات الأنشطة)</span>
            </button>
            ...
            >
              ...
              <span>Subscription & Usage (الاشتراك)</span>
            </button>
            ...
            >
              ...
              <span>Bug Bounty Platform (مكافآت)</span>
            </button>
            ...
            >
              ...
              <span>Platform Constitution (الدستور)</span>
            </button>

            <button
              onClick={() => setActiveTab('landing')}
              className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs font-medium text-slate-500 hover:text-slate-300 hover:bg-slate-900/60 transition-all mt-4 border-t border-slate-800/80"
            >
              <Home className="w-4 h-4" />
              <span>الصفحة التعريفية (Landing)</span>
            </button>
