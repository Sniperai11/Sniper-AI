...
export let reportsHistory: any[] = [
  ...
  },
  {
    ...
    vulnerabilities: [
      {
        id: "vuln-4",
        targetId: "tar-1", // Fixed typo in reference (from original tar-1 under portal.digitaltech.sa, let's keep exact as server.ts)
        targetName: "البوابة الرئيسية للعملاء",
        title: "انكشاف معلومات الخادم والمكتبة المستعملة (Server Header Disclosure)",
        type: "Information Disclosure",
        severity: "Low" as const,
...
export let bugBountyLeaderboard = [
...
export let bugBountySubmissions = [
  {
    id: "sub-1",
    targetName: "البوابة الرئيسية للعملاء (portal.digitaltech.sa)",
